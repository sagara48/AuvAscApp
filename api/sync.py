...
# ==== STEP 2b: Wsoucont2 - 10 derniers passages + infos complémentaires ====
def sync_passages(sector_idx):
    ...
    for e in items:
        ...
        if id_ws:
            update_data = {
                'updated_at': datetime.now().isoformat(),
                # 10 derniers passages (libellés et dates)
                ...
                # Champs supplémentaires Wsoucont2 - Dates contrôles
